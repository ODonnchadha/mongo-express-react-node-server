...
// @desc      Current user's profile by user id
// @access    Public
...
router.get('/all', (req, res) => {
  ...
  .then(profiles => {
    if (!profiles) {
      errors.noprofile = 'There is no profiles available'
      return res.status(404).json(errors);
    }
    res.json(profiles);
  })
...
router.post('/', passport.authenticate('jwt', { session: false}), (req, res) => {
  ...
  if (req.body.gethubusername) profileFields.gethubusername = req.body.gethubusername;
